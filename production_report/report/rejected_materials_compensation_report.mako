...
<head>
    ...
    <title>Rejected Materials Compensation Report</title>
    
</head>
	<body>
		<%setLang(user.lang)%>
		<h2 align="center"><b><u>Report of the Rejected Materials and Compensation</u></b></h2>
		<br/>
		<br/>
		...
		<table width="100%" cellspacing="0" cellpadding="4">
			<tr height="30px">
				...
				<td rowspan="2" width="13%" align="left" id="tableheading"><b>${_("Place of Reject the Line/Storehouse inputs")}</b></td>
				...
				<td rowspan="2" width="12%" align="left" id="tableheading"><b>${_("No. LOT (In case of Compensation from KD Materials)")}</b></td>
			</tr>
